...
import { peersSelector, DELETE_PEERS_SUCCEESS, ROOM_JOIN_SOCKET_EVENT, LEAVE_SOCKET_EVENT, CLOSE_LOCAL_STREAM_REQUEST, DELETE_ALL_PEERS_SUCCEESS } from '../webrtc'
import { iRegRoomParams, iJoinRoomParams, iRoomJoinMode } from './entity/interface'
...
import RoomEntity, { iRoom } from './entity/room-entity'
