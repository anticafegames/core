...
//Mobile SDK
export const vkMobileKey = 7544835
...
export const vkAuthUrl = `https://oauth.vk.com/authorize?client_id=${vkAppId}&display=popup&redirect_uri=${!window.isNative && window.location.protocol}//${!window.isNative && window.location.host}/auth&scope=offline,photos&response_type=token&v=${vkApiVersion}&state=anticafe`
